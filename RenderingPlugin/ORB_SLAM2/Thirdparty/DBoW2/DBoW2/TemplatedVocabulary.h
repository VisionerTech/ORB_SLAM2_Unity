...
bool TemplatedVocabulary<TDescriptor,F>::loadFromTextFile(const std::string &filename)
{
	...
	//cout << "size_node" << size_node << endl;
	//cout << "nb_nodes" << nb_nodes << endl;
	//cout << "m_k" << m_k << endl;
	//cout << "m_L" << m_L << endl;
	//cout << "m_scoring" << n1 << endl;
	//cout << "m_weighting" << n2 << endl;
	...
	//cout << "expected_nodes" << expected_nodes << endl;
	...
	//cout << "m_nodes_size" << m_nodes.size() << endl;
...
// --------------------------------------------------------------------------
#define NODE_SIZE 41
//#define NODE_NUMBER 908079153
//#define M_K 10
//#define M_L 6
//#define M_SCORING 942743602
//#define M_WEIGHTING 942743608
template<class TDescriptor, class F>
bool TemplatedVocabulary<TDescriptor,F>::loadFromBinaryFile(const std::string &filename) {
  ...
  //nb_nodes = 1082074;
  //size_node = 41;
  //m_scoring = ScoringType::L1_NORM;
  //m_weighting = WeightingType::TF_IDF;

  //cout << "size_node" << size_node << endl;
  //cout << "nb_nodes" << nb_nodes << endl;
  //cout << "m_k" << m_k << endl;
  //cout << "m_L" << m_L << endl;
  //cout << "m_scoring" << m_scoring << endl;
  //cout << "m_weighting" << m_weighting << endl;
